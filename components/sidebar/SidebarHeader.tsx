...
import { 
  IconChevronsDown, IconChevronLeft, IconSettings, IconWriting, IconPizza 
} from '@tabler/icons';
...
export default function SidebarHeader(props: Props) {
  ...
  return (
    <div className="relative">
      <Menu>
        <Menu.Button className="flex items-center justify-between w-full py-2 pl-4 overflow-x-hidden text-left text-gray-800 hover:bg-gray-200 active:bg-gray-300 dark:text-gray-200 dark:hover:bg-gray-700 dark:active:bg-gray-600 overflow-ellipsis whitespace-nowrap focus:outline-none">
          <div className="flex items-center flex-1">
            <span className="mr-1 px-1 font-bold select-none">mdSilo</span>
