  ...
  return (
    <MainView showNavbar={false} showFooter={false}>
      <div className="flex flex-col">
          ...
          <div className="py-16 md:py-24">
            <div className="container px-6 text-center">
              ...
              <div className="flex-1 mx-auto">
                ...
                <a href="https://spc.fly.dev" target="_blank" rel="noopener noreferrer" className="inline-flex mt-4 mr-2 text-xl btn">
        ...
        <div className="p-12 bg-neutral-200">
          <div className="container flex flex-col lg:flex-row items-center justify-center border-b-2 border-slate-600">
            ...
            <div className="container flex flex-col items-center justify-center px-2">
              ...
              <p className="text-2xl pt-2 text-center text-black">
              ...
              <p className="text-base pt-2 text-center text-slate-400">
          ...
          <div className="container flex flex-col lg:flex-row items-center justify-center">
            ...
            <div className="container flex flex-col items-center justify-center px-2">
              ...
              <p className="text-2xl pt-2 text-center text-black">
                Preview support Markdown, Mindmap, mermaid diagram, ABC music notes and more.
              </p>
              <p className="text-base pt-2 text-center text-slate-400">
