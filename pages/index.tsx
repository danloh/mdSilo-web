          ...
          <div className="container flex flex-col lg:flex-row items-center justify-center my-12">
            <div className="container flex flex-col items-center justify-center px-2">
              ...
              <p className="text-2xl pt-2 text-center text-white">
                Available for Windows(<a href="https://github.com/mdSilo/mdSilo/releases/download/app-v0.5.1/mdsilo_0.5.1_x64_en-US.msi" className="link" target="_blank" rel="noopener noreferrer">msi</a>), macOS(<a href="https://github.com/mdSilo/mdSilo/releases/download/app-v0.5.1/mdsilo_0.5.1_x64.dmg" className="link" target="_blank" rel="noopener noreferrer">dmg</a>, <a href="https://github.com/mdSilo/mdSilo/releases/download/app-v0.5.1/mdsilo_x64.app.tar.gz" className="link" target="_blank" rel="noopener noreferrer">app</a>), Linux(<a href="https://github.com/mdSilo/mdSilo/releases/download/app-v0.5.1/mdsilo_0.5.1_amd64.deb" className="link" target="_blank" rel="noopener noreferrer">deb</a>, <a href="https://github.com/mdSilo/mdSilo/releases/download/app-v0.5.1/mdsilo_0.5.1_amd64.AppImage" className="link" target="_blank" rel="noopener noreferrer">AppImage</a>) and <a href="/app" className="link" target="_blank" rel="noopener noreferrer">Web</a>. 
              </p>
              <div className="flex flex-wrap items-center justify-center mt-4">
                <button className="m-2 text-lg text-white text-center bg-slate-700 py-2 px-4 rounded hover:bg-green-400">
                  <a href="https://github.com/mdSilo/mdSilo/releases" target="_blank" rel="noopener noreferrer">VERSION  0.5.1</a>
                </button>
