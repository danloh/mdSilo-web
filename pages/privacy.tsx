  ...
  return (
    <MainView showFooter={true}>
      ...
      <article className="container py-6 prose prose-primary text-gray-300">
        ...
        <p>
          <b>TL;DR</b>: You fully own your data, and we do not
        ...
        <p>
          ...
          website operated by The mdSilo Team.
        </p>
        ...
        <p>mdSilo uses the collected data for various purposes:</p>
        ...
        <p>
          mdSilo will take all the steps reasonably necessary to ensure that
        ...
        <p>
          (d) users are able to change their personal information by contacting us
        </p>
        ...
        <p>
          ...
          please send your request(s) to us.
        </p>
        ...
        <p>The payment processors we work with are: Stripe.</p>
