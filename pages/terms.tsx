  ...
  return (
    <MainView showFooter={true}>
      ...
      <article className="container px-6 py-16 prose prose-primary text-gray-300">
        ...
        <p>
          Welcome to mdSilo (“<b>Company</b>”, “<b>we</b>”, “<b>our</b>
          ”, “<b>us</b>”)!
        </p>
        ...
        <p>
          ...
          and periodic basis (“<b>Billing Cycle</b>”). Billing cycles are set
          either on a monthly or yearly basis, depending on the type of
        ...
        <p>
          ...
          renew under the exact same conditions unless you cancel it or mdSilo
          cancels it. You may cancel your Subscription renewal either through
          your online account management page or by contacting mdSilo.
        </p>

        <p>
          A valid payment method, including credit card, is required to process
          the payment for your subscription. You shall provide mdSilo with
          ...
          authorize mdSilo to charge all Subscription fees incurred through
          your account to any such payment instruments.
        </p>

        <p>
          Should automatic billing fail to occur for any reason, mdSilo will
        ...
        <p>
          mdSilo may, at its sole discretion, offer a Subscription with a free
        ...
        <p>
          At any time and without notice, mdSilo reserves the right to (i)
        ...
        <p>
          mdSilo, in its sole discretion and at any time, may modify
        ...
        <p>
          mdSilo will provide you with a reasonable prior notice of any change
        ...
        <p>
          mdSilo has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>

        <h2>9. Prohibited Uses and Abuses</h2>
        ...
        <p>
          ...
          property of mdSilo and its licensors. Service is protected by
          ...
          product or service without the prior written consent of mdSilo.
        </p>
        ...
        <p>
          ...
          owner or authorized to act on behalf of the copyright owners .
        </p>

        <h2>16. Error Reporting and Feedback</h2>

        <p>
          You may provide us via third party sites and tools with information and feedback
        ...
        <p>
          ...
          that are not owned or controlled by mdSilo.
        </p>

        <p>
          mdSilo has no control over, and assumes no responsibility for the
        ...
        <p>
          YOU ACKNOWLEDGE AND AGREE THAT mdSilo SHALL NOT BE RESPONSIBLE OR
