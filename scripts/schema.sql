...
CREATE TYPE plan_id AS ENUM ('preparing', 'pro', 'promised');

DROP TYPE IF EXISTS subscription_status CASCADE;
CREATE TYPE subscription_status AS ENUM ('active', 'inactive');

DROP TYPE IF EXISTS billing_frequency CASCADE;
CREATE TYPE billing_frequency AS ENUM ('monthly', 'yearly', 'one_time');
...
CREATE TABLE public.notes (
  ...
  cover text NULL, 
  attr jsonb NULL DEFAULT ('{ "Type": "", "Author": "", "Publisher": "", "Publish": "", "UID": "", "Link": "" }'::text)::jsonb, -- for wiki page
  created_at timestamptz NOT NULL DEFAULT now(),
  updated_at timestamptz NOT NULL DEFAULT now(),
  is_pub BOOLEAN NOT NULL DEFAULT FALSE, -- public private note
  is_wiki BOOLEAN NOT NULL DEFAULT FALSE, -- pub wiki page
  is_daily BOOLEAN NOT NULL DEFAULT FALSE, -- daily note
